<template>
    <main>
        <div class="container-fluid px-4">
            <h2 class="mt-4">Book Borrowing</h2>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <button @click="Add()" data-bs-toggle="modal" data-bs-target="#borrowing_modal" class="btn btn-primary btn-sm float-end"><i class="fas fa-plus fa-fw"></i> Add Book Borrowing</button>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="borrow_date" class="form-label">Date of Borrowing</label>
                                            <input type="date" class="form-control" id="borrow_date" v-model="borrow_date" placeholder="Date of Borrowing">
                                        </div>
                                        <div class="mb-3">
                                            <label for="return_date" class="form-label">Date of Returning</label>
                                            <input type="date" class="form-control" id="return_date" v-model="return_date" placeholder="Date of Returning">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row" v-for="(detail, counter) in transaction_detail" :key="counter">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input class="form-control" placeholder="Quantity" type="number" v-model="detail.qty"> 
                                                </div>
                                            </div>
                                            <div class="col-md-1">
